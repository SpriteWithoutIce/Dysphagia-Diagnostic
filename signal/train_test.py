...
def main():
    df = read_csv('./signal_1007_lyh.csv')  # 替换为你的CSV文件路径
    ...
    write_csv(train_df, 'train_dataset_lyh_im.csv')
    write_csv(test_df, 'test_dataset_lyh_im.csv')
    write_csv(new_df, 'test_label_lyh_im.csv')
